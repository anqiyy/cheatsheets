...
% Add this package for better vertical spacing control
...
\begin{multicols*}{3} % Use multicols* environment for better column balancing

% Define consistent vertical spacing between boxes
\newcommand{\boxsep}{\vspace{2pt plus 1pt minus 1pt}}
...
% Force column break if needed
\needspace{5\baselineskip} % Ensure at least 5 lines of space before breaking
